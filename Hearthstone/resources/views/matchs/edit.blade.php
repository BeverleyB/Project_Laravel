...
@section('content')
<div class="container">
      <h2 class="text-center">Edit the match</h2><br/>
        ...
        <div class="row">
          ...
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="score_1" value="{{$matchs->score_1}}">
            </div>
          </div>
          ...
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="score_2" value="{{$matchs->score_2}}">
            </div>
          </div>
